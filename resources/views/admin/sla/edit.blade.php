    ...
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        ...
        <form method="POST" action="{{ route('admin.sla.update', $kategori) }}" class="p-6" id="form-edit-sla">
            ...
            <div class="mb-6">
                ...
                <div class="relative">
                    ...
                    <input type="number"
                           ...
                           min="1"
                           max="720"
                           class="w-full pl-12 pr-16 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#022448]/20 focus:border-[#022448] text-lg font-bold text-gray-900 transition-all"
                           required>
                ...
                <div class="flex flex-wrap gap-2 mt-3">
                    <button type="button" onclick="document.getElementById('sla_jam').value=6"
                            class="px-3 py-1 bg-red-50 text-red-700 rounded-lg text-xs font-medium hover:bg-red-100 transition ring-1 ring-red-200">
                        6 jam
                    </button>
                    <button type="button" onclick="document.getElementById('sla_jam').value=12"
                            class="px-3 py-1 bg-orange-50 text-orange-700 rounded-lg text-xs font-medium hover:bg-orange-100 transition ring-1 ring-orange-200">
                        12 jam
                    </button>
                    <button type="button" onclick="document.getElementById('sla_jam').value=24"
                            class="px-3 py-1 bg-amber-50 text-amber-700 rounded-lg text-xs font-medium hover:bg-amber-100 transition ring-1 ring-amber-200">
                        24 jam
                    </button>
                    <button type="button" onclick="document.getElementById('sla_jam').value=48"
                            class="px-3 py-1 bg-sky-50 text-sky-700 rounded-lg text-xs font-medium hover:bg-sky-100 transition ring-1 ring-sky-200">
                        48 jam
                    </button>
                    <button type="button" onclick="document.getElementById('sla_jam').value=72"
                            class="px-3 py-1 bg-indigo-50 text-indigo-700 rounded-lg text-xs font-medium hover:bg-indigo-100 transition ring-1 ring-indigo-200">
                        72 jam
                    </button>
                </div>
            ...
            <div class="flex gap-3">
                <button type="submit"
                        id="btn-simpan-sla"
                        class="flex-1 inline-flex items-center justify-center gap-2 bg-[#022448] text-white py-3 rounded-xl font-semibold hover:bg-[#1e3a5f] transition-all duration-200 shadow-lg shadow-[#022448]/20 hover:shadow-xl hover:shadow-[#022448]/30">
